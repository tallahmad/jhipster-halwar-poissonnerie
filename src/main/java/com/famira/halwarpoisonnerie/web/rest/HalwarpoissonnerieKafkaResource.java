...
@RestController
@RequestMapping("/api/halwarpoissonnerie-kafka")
public class HalwarpoissonnerieKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HalwarpoissonnerieKafkaResource.class);
    ...
    public HalwarpoissonnerieKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
